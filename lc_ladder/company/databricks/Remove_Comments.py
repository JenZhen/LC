...
# For example, source = "string s = "/* Not a comment. */";" will not be a test case. (Also, nothing else such as defines or macros will interfere with the comments.)
#
...
class Solution:
    def removeComments(self, source: List[str]) -> List[str]:
        ...
        for line in source:
            ...
            # if has something and not in block, make a string and attach
            # if has something but in block, leave as is and leave for next line
